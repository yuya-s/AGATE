...
from repeat2_utils.graph_prediction_IO import get_appeared_InputDirs # appeared link
from repeat2_utils.graph_prediction_IO import get_disappeared_InputDirs # disappeared link
from repeat2_utils.graph_prediction_IO import get_new_InputDirs # new link
from repeat2_utils.graph_prediction_IO import get_lost_InputDirs # lost node
...
def link_prediction(n_appeared, p_appeared, n_disappeared, p_disappeared, n_new, p_new, n_lost, p_lost, is_train, is_valid, is_test):
    ...
    appeared_edge_pred_set_list, appeared_edge_true_set_list, recall_appeared_edge, precision_appeared_edge, f1_score_appeared_edge = get_component_result("edge", probability_appeared_InputDir, num_appeared_InputDir, all_node_num + n_expanded, is_train, is_valid, is_test)
