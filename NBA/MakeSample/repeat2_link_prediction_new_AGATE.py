...
from setting_param import Model_repeat2_attribute_prediction_new_utilize_new_attribute_link_LSTM_OutputDir as AGATE_Out_InputDir
from setting_param import MakeSample_repeat2_link_prediction_new_AGATE_OutputDir as OutputDir
