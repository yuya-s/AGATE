...
from setting_param import MakeSample_repeat2_link_prediction_disappeared_InputDir as InputDir
from setting_param import MakeSample_repeat2_link_prediction_disappeared_utilize_existing_attribute_OutputDir as OutputDir_0
from setting_param import MakeSample_repeat2_link_prediction_disappeared_utilize_lost_OutputDir as OutputDir_1
from setting_param import MakeSample_repeat2_link_prediction_disappeared_utilize_new_attribute_link_OutputDir as OutputDir_2
from setting_param import MakeSample_repeat2_link_prediction_disappeared_utilize_disappeared_OutputDir as OutputDir_4
from setting_param import MakeSample_repeat2_link_prediction_disappeared_utilize_appeared_OutputDir as OutputDir_8
from setting_param import MakeSample_repeat2_link_prediction_disappeared_utilize_all_OutputDir as OutputDir_15
...
for c_idx in range(16):
    ...
    for ts in range(L, EXIST_TABLE.shape[1] - L):
        ...
        label[:all_node_num, :all_node_num] = get_adjacency_matrix(ts_test, L, "disappeared")
        ...
        mask[:all_node_num, :all_node_num] = get_adjacency_matrix(ts_train[-1], L, 'all')
