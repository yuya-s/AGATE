...
from setting_param import MakeSample_repeat1_link_prediction_appeared_utilize_all_OutputDir as OutputDir_15#TODO:utilize_all
OutputDir = {0:OutputDir_0, 1:OutputDir_1, 2:OutputDir_2, 4:OutputDir_4, 8:OutputDir_8, 15:OutputDir_15}#TODO:utilize_all
...
for c_idx in range(16):
    if not c_idx in [0, 1, 2, 4, 8, 15]:#TODO:utlize_all
    ...
    for ts in range(L, EXIST_TABLE.shape[1]-L):
        ...
        elif (c_idx == 1) or (c_idx == 4) or (c_idx == 8):#TODO:utilize_all
            pred_attribute[c_idx][ts] = NodeAttribute(ts_train[-1])
        elif c_idx == 15:#TODO:utilize_all
            pred_attribute[c_idx][ts] = np.concatenate([pred_attribute_e, pred_attribute_n], axis=0)#TODO:utilize_all

for c_idx in range(16):
    if not c_idx in [0, 1, 2, 4, 8, 15]:#TODO:utilize_all
