...
from setting_param import Model_repeat1_node_prediction_lost_utilize_new_attribute_link_Baseline_OutputDir as OutputDir
...
parser.add_argument('--annotation_dim', type=int, default=repeat1_node_prediction_lost_utilize_new_attribute_link_annotation_dim, help='GGNN hidden annotation size')
