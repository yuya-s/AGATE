...
from setting_param import Model_repeat1_link_prediction_appeared_utilize_disappeared_Baseline_OutputDir as OutputDir
...
parser.add_argument('--annotation_dim', type=int, default=repeat1_link_prediction_appeared_utilize_disappeared_annotation_dim, help='GGNN hidden annotation size')
