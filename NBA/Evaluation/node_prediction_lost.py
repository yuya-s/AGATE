...
from setting_param import MakeSample_node_prediction_lost_InputDir

EXIST_TABLE = np.load(MakeSample_node_prediction_lost_InputDir + '/exist_table.npy')

from setting_param import Evaluation_node_prediction_lost_Baseline_InputDir as Baseline_InputDir
...
from setting_param import Evaluation_node_prediction_lost_DynGEM_InputDir as DynGEM_InputDir
from setting_param import Evaluation_node_prediction_lost_FNN_InputDir as FNN_InputDir
