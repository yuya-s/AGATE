...
from setting_param import Evaluation_attribute_prediction_exist_Tm_with_transfer_Baseline_InputDir as Baseline_InputDir
from setting_param import Evaluation_attribute_prediction_exist_Tm_with_transfer_LSTM_InputDir as LSTM_InputDir
from setting_param import Evaluation_attribute_prediction_exist_Tm_with_transfer_STGGNN_InputDir as STGGNN_InputDir
from setting_param import Evaluation_attribute_prediction_exist_Tm_with_transfer_EGCNh_InputDir as EGCNh_InputDir
from setting_param import Evaluation_attribute_prediction_exist_Tm_with_transfer_STGCN_InputDir as STGCN_InputDir
from setting_param import Evaluation_attribute_prediction_exist_Tm_with_transfer_EGCNo_InputDir as EGCNo_InputDir
from setting_param import Evaluation_attribute_prediction_exist_Tm_with_transfer_GCN_InputDir as GCN_InputDir

from setting_param import Evaluation_attribute_prediction_exist_Tm_with_transfer_OutputDir as OutputDir
...
for idx, method in enumerate(methods):
    ...
    plt.xticks(tick_marks, Tm_with_transfer_list, rotation=90, fontsize=4)
    plt.yticks(tick_marks, Tm_with_transfer_list, rotation=0, fontsize=4)
    plt.grid(False)
