...
if opt.node_type == "new":
    from setting_param import Evaluation_prediction_num_of_node_new_LSTM_InputDir as LSTM_InputDir
    from setting_param import Evaluation_prediction_num_of_node_new_Baseline_InputDir as Baseline_InputDir
    from setting_param import Evaluation_prediction_num_of_node_new_OutputDir as OutputDir
elif opt.node_type == "lost":
    from setting_param import Evaluation_prediction_num_of_node_lost_LSTM_InputDir as LSTM_InputDir
    from setting_param import Evaluation_prediction_num_of_node_lost_Baseline_InputDir as Baseline_InputDir
    from setting_param import Evaluation_prediction_num_of_node_lost_OutputDir as OutputDir
