...
from setting_param import Evaluation_repeat1_link_prediction_new_utilize_new_attribute_link_Baseline_InputDir as Baseline_InputDir
from setting_param import Evaluation_repeat1_link_prediction_new_utilize_new_attribute_link_Random_InputDir as Random_InputDir
from setting_param import Evaluation_repeat1_link_prediction_new_utilize_new_attribute_link_COSSIMMLP_InputDir as COSSIMMLP_InputDir
from setting_param import Evaluation_repeat1_link_prediction_new_utilize_new_attribute_link_STGGNN_InputDir as STGGNN_InputDir
from setting_param import Evaluation_repeat1_link_prediction_new_utilize_new_attribute_link_EGCNh_InputDir as EGCNh_InputDir
from setting_param import Evaluation_repeat1_link_prediction_new_utilize_new_attribute_link_STGCN_InputDir as STGCN_InputDir
from setting_param import Evaluation_repeat1_link_prediction_new_utilize_new_attribute_link_EGCNo_InputDir as EGCNo_InputDir
from setting_param import Evaluation_repeat1_link_prediction_new_utilize_new_attribute_link_GCN_InputDir as GCN_InputDir
# from setting_param import Evaluation_repeat1_link_prediction_new_utilize_new_attribute_link_DynGEM_InputDir as DynGEM_InputDir
from setting_param import Evaluation_repeat1_link_prediction_new_utilize_new_attribute_link_LSTM_InputDir as LSTM_InputDir

from setting_param import Evaluation_repeat1_link_prediction_new_utilize_new_attribute_link_OutputDir as OutputDir
...
InputDirs = [Baseline_InputDir, Random_InputDir, COSSIMMLP_InputDir, LSTM_InputDir, GCN_InputDir, STGCN_InputDir, EGCNh_InputDir, EGCNo_InputDir, STGGNN_InputDir]
methods = ['Baseline', 'Random', 'FNN', 'LSTM', 'GCN', 'STGCN', 'EvolveGCN-H', 'EvolveGCN-O', 'TGGNN']
