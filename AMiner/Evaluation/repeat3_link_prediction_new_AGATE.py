...
from setting_param import Evaluation_repeat3_link_prediction_new_AGATE_COSSIMMLP_InputDir as COSSIMMLP_InputDir
from setting_param import Evaluation_repeat3_link_prediction_new_AGATE_FNN_InputDir as FNN_InputDir
from setting_param import Evaluation_repeat3_link_prediction_new_AGATE_DEAL_InputDir as DEAL_InputDir
from setting_param import Evaluation_repeat3_link_prediction_new_AGATE_OutputDir as OutputDir

# InputDirs = [COSSIMMLP_InputDir, FNN_InputDir, DEAL_InputDir]
# methods = ['COSSIMMLP', 'FNN', 'DEAL']
InputDirs = [DEAL_InputDir]
methods = ['DEAL']
